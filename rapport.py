# -*- coding: utf-8 -*-
"""Copy of convolution.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1i_gKhwxYMMzgRBI3u8otmU1UwRTPIwyQ
...
Malgré de nombreux essais, je n'ai pas réussi à dépasser 84% d'accuracy.

Avec la fonction d'activation softmax je ne dépassais pas les 64% d'accuracy, j'ai donc opté pour la fonction ReLu qui m'a permis de franchir le premier cap des 80%.

J'ai essayé de modifier les couches utilisés en faisant varier les paramètres, en supprimer plusieurs ou en rajouter mais je n'ai pas trouvé de grosses différences dans l'accuracy.

En modifiant le minibatch_size ou le learning rate je n'ai pas vu de différences significatives non plus, l'accuracy ne variait que de +/- 1%.

En augmentant le momentum, j'ai remarqué que le nombre d'epoch pour obtenir la même accuracy qu'avec un momentum de 0 était bien plus faible.
